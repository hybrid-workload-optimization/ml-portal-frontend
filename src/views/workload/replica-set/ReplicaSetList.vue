...
export default {
  ...
  methods: {
    ...
    moveToDetailPage(data) {
      ...
      if (replicaSetIdx) {
        this.$router.push(`/workload/replica-set/detail/${replicaSetIdx}`)
      }
    },
    ...
    async onChangeItem() {
      console.log('[onChangeItem]', this.thirdValue)
