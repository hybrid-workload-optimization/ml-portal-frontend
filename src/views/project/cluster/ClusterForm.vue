...
import InputPart from '@/views/project/cluster/components/ClusterRegInputPart.vue'
import NewCluster from '@/views/project/cluster/components/ClusterRegNewCluster.vue'
import ImportCluster from '@/views/project/cluster/components/ClusterRegImport.vue'
