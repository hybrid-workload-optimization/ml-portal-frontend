  ...
  props: {
    ...
    */
    ...
    appendGrow: {
      type: Boolean,
      default: false,
      description: '텍스트 양에 따라 자동으로 텍스트 영역 확장',
    },
    autofocus: {
      type: Boolean,
      default: false,
    ...
    errorCount: {
      type: [String, Number],
      default: 1,
      description: '한 번에 표시해야 하는 총 오류 수',
    },
    errorMessage: {
      type: [String, Array],
      default() {
    ...
    messages: {
      ...
      description: '문자열을 사용하는 경우 메시지 또는 메시지 목록을 표시',
    },
    noResize: {
      type: Boolean,
      default: false,
      description: '크기 조정 핸들 제거',
    },
    outlined: {
      type: Boolean,
      default: false,
    ...
    successMessage: {
      ...
      description: '입력을 성공 상태로 만들고 사용자 지정 성공 메시지를 전달',
    },
    suffix: {
      type: String,
      default: undefined,
  ...
  methods: {
    ...
    */
    onClickPrependInnerIcon(event) {
      ...
      this.$emit('click-prepend-innner-icon', event)
    },
    /*
