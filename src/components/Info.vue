<template>
  <div class="sp-info">
    <div class="info__body">
      ...
      <div class="info__second-title">CoMP Portal</div>
...
.sp-info {
  ...
  .#{$this}__body {
    ...
    .#{$this}__first-title {
      @include set-text(500, 22, rgba($color: #fff, $alpha: 1));
    }

    .#{$this}__second-title {
      @include set-text(bold, 48, rgba($color: #fff, $alpha: 1));
      line-height: 1;
    }
    ...
    .#{$this}__desc {
      margin-top: 52px;
      width: 209px;
      @include set-text(500, 20, rgba($color: #fff, $alpha: 1));
    }
  }
  .#{$this}__footer {
    padding-bottom: 57px;
    @include set-text(500, 11, rgba($color: #fff, $alpha: 0.3));
  }
}
</style>
